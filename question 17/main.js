...
var newGuestList = previous_list;
...
for (var i = 0; i < newGuestList.length; ++i) {
    console.log("Helle ".concat(newGuestList[i], ", This is to inform you that you are still in my list and I will be waiting for you at dinner."));
}
